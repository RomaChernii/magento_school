...
angular.module('complete-backup', ['ngStorage'])
    ...
    .controller('completeBackupController', ['$rootScope', '$scope', '$state', '$http', '$timeout', 'BACKUPCOUNTER', '$localStorage', '$q', function ($rootScope, $scope, $state, $http, $timeout, BACKUPCOUNTER, $localStorage, $q) {
        ...
        $scope.items = {
            'backup-check': {
                url:'Index.php.php/backup-action-items/check',
                show: function() {
                    $scope.startProgress();
            ...
            'store-maintenance': {
                url:'Index.php.php/maintenance/index',
                show: function() {
                    $scope.startProgress();
            ...
            'backup-create': {
                url:'Index.php.php/backup-action-items/create',
                show: function() {
                    $scope.startProgress();
        ...
        $scope.disableMeintenanceMode = function() {
            $http.post('Index.php.php/maintenance/index', {'disable' : true}).success(function(data) {
            });
        };
