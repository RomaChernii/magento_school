...
angular.module('readiness-check', ['remove-dialog'])
    ...
    .controller('readinessCheckController', ['$rootScope', '$scope', '$localStorage', '$http', '$timeout', '$sce', '$state', 'COUNTER', 'ngDialog', function ($rootScope, $scope, $localStorage, $http, $timeout, $sce, $state, COUNTER, ngDialog) {
        ...
        switch ($state.current.type) {
            case 'uninstall':
                $scope.dependencyUrl = 'Index.php.php/dependency-check/uninstall-dependency-check';
            ...
            case 'disable':
                ...
                $scope.dependencyUrl = 'Index.php.php/dependency-check/enable-disable-dependency-check';
                if ($localStorage.packages) {
                ...
                break;
            default:
                $scope.dependencyUrl = 'Index.php.php/dependency-check/component-dependency';
                if ($localStorage.packages) {
                    $scope.componentDependency.packages = $localStorage.packages;
                }
        }
        ...
        $scope.items = {
            'php-settings': {
                url:'Index.php.php/environment/php-settings',
            ...
            'php-extensions': {
                url:'Index.php.php/environment/php-extensions',
                params: $scope.actionFrom,
                useGet: true,
                show: function() {
                    $scope.startProgress();
        ...
        if ($scope.actionFrom === 'installer') {
            $scope.items['php-version'] = {
                url:'Index.php.php/environment/php-version',
                params: $scope.actionFrom,
                useGet: true,
                show: function() {
                    $scope.startProgress();
            ...
            $scope.items['file-permissions'] = {
                url:'Index.php.php/environment/file-permissions',
                show: function() {
                    $scope.startProgress();
        ...
        if ($scope.actionFrom === 'updater') {
            $scope.items['updater-application'] = {
                url:'Index.php.php/environment/updater-application',
                show: function() {
                    $scope.startProgress();
            ...
            $scope.items['cron-script'] = {
                url:'Index.php.php/environment/cron-script',
                show: function() {
                    $scope.startProgress();
