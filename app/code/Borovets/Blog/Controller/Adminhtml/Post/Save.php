...
use Borovets\Blog\Model\Post\Image\Uploader;
use Borovets\Blog\Api\PostRepositoryInterface;
use Borovets\Blog\Model\PostFactory;
...
class Save extends Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Borovets_Blog::post_save';
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $this->dataPersistor->set('borovets_blog_post', $data);
