 ...
 */
namespace Borovets\Blog\Model\Post;
 ...
 * Class DataProvider
 *
 * @package Borovets\Blog\Model\Post\DataProvider
 */
class DataProvider extends AbstractDataProvider
{
     ...
     * Post collection
     *
     * @var \Borovets\Blog\Model\ResourceModel\Post\Collection
     */
    ...
    public function getData()
    {
        if ($this->loadedData === null) {
            ...
            $data = $this->dataPersistor->get('borovets_blog_post');
            if (!empty($data)) {
