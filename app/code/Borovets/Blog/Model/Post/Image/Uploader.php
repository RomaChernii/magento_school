<?php
/**
 * Borovets Blog order plan file upload
 */
namespace Borovets\Blog\Model\Post\Image;
 ...
 * Class Uploader
 *
 * @package Borovets\Blog\Model\Order\Stand
 */
class Uploader extends ImageUploader
{
     ...
     * Plan path
     */
    const FILE_PATH = 'borovets_blog/post/image';
