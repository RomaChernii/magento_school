...
use Chleck\Blog\Model\Post\Image\Uploader;
use Chleck\Blog\Api\PostRepositoryInterface;
use Chleck\Blog\Model\PostFactory;
...
class Save extends Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Chleck_Blog::post_save';
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $this->dataPersistor->set('chleck_blog_post', $data);
