...
use Chleck\Blog\Api\CommentRepositoryInterface;
use Chleck\Blog\Model\ResourceModel\Comment as ResourceComment;
use Chleck\Blog\Model\ResourceModel\Comment\CollectionFactory as CommentCollectionFactory;

/**
 * Class CommentRepository
 *
 * @package Chleck\Blog\Model\CommentRepository
 *
...
class CommentRepository implements CommentRepositoryInterface
{
     ...
     * Save Comment data
     *
     * @param \Chleck\Blog\Api\Data\CommentInterface $comment
     *
     * @return Comment
     *
    ...
    /**
     * Load Comment data by given Commentst Identity
     *
     ...
     *
     * @return \Chleck\Blog\Model\ResourceModel\Comment\Collection
     *
     ...
     * Delete comment
     *
     * @param \Chleck\Blog\Api\Data\CommentInterface $commentId
     *
     * @return bool
     *
     * @throws CouldNotDeleteException
     */
    public function delete(Data\CommentInterface $commentId)
    {
        try {
            $this->resource->delete($commentId);
        } catch (\Exception $exception) {
