...
class Post extends AbstractModel implements PostInterface, IdentityInterface
{
    ...
    /**
     * Skavronskiy post cache tag
     */
    const CACHE_TAG = 'skavronskiy_blog_post';
     ...
     * @var string
     */
    public $cacheTag = 'skavronskiy_blog_post';
     ...
     * @var string
     */
    public $eventPrefix = 'skavronskiy_blog_post';
    ...
    {
        $this->_init('Skavronskiy\Blog\Model\ResourceModel\Post');
    }
