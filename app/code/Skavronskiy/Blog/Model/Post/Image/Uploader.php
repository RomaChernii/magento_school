<?php
/**
 * Skavronskiy Blog order plan file upload
 *
 */
namespace Skavronskiy\Blog\Model\Post\Image;
 ...
 * Class Uploader
 *
 * @package Skavronskiy\Blog\Model\Order\Stand
 */
class Uploader extends ImageUploader
{
     ...
     * Plan path
     */
    const FILE_PATH = 'skavronskiy_blog/post/image';
