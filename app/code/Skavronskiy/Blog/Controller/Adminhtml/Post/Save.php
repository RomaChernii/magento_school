...
use Skavronskiy\Blog\Model\Post\Image\Uploader;
use Skavronskiy\Blog\Api\PostRepositoryInterface;
use Skavronskiy\Blog\Model\PostFactory;
...
class Save extends Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Skavronskiy_Blog::post_save';
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $this->dataPersistor->set('skavronskiy_blog_post', $data);
