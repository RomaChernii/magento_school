...
class Post extends AbstractModel implements PostInterface, IdentityInterface
{
    ...
    /**
     * Lebed post cache tag
     */
    const CACHE_TAG = 'lebed_blog_post';
     ...
     * @var string
     */
    public $cacheTag = 'lebed_blog_post';
     ...
     * @var string
     */
    public $eventPrefix = 'lebed_blog_post';
    ...
    {
        $this->_init('Lebed\Blog\Model\ResourceModel\Post');
    }
