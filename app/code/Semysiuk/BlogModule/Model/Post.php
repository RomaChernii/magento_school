 ...
 * Class Post
 *
 * @package Semysiuk\BlogModule\Model\Post
 *
 */
class Post extends AbstractModel implements PostInterface, IdentityInterface
{
    ...
    /**
     * Semysiuk post cache tag
     */
    const CACHE_TAG = 'semysiuk_blog_post';
     ...
     * @var string
     */
    public $cacheTag = 'semysiuk_blog_post';
     ...
     * @var string
     */
    public $eventPrefix = 'semysiuk_blog_post';
    ...
    {
        $this->_init('Semysiuk\BlogModule\Model\ResourceModel\Post');
    }
