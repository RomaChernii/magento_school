<?php
/**
 * Dehtiarov Blog order plan file upload
 *
 * @category  Dehtiarov
 ...
 */
namespace Dehtiarov\BlogVideh\Model\Post\Image;
 ...
 * Class Uploader
 *
 * @package Dehtiarov\BlogVideh\Model\Order\Stand
 */
class Uploader extends ImageUploader
{
     ...
     * Plan path
     */
    const FILE_PATH = 'dehtiarov_blogvideh/post/image';
